-- Active: 1711656549393@@mysql-x-cyl.alwaysdata.net@3306@x-cyl_bibliofun
...
#sortir la liste des livres likes filtrés par auteur dans l'ordre croissant
...
#Condenser les lignes les plus likées avec somme des likes par ligne trier dans ordre decroissant
...
#sortir les 10 derniers livres enregistrés
