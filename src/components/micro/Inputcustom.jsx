...
export default function InputCustom({ labelName, type, variant }) {
  let inputZone = null;
      ...
      <>
          ...
          <input className={classNames([
            "w-[80%] ml-7 md:ml-2 md:h-10 border-4 border-border-input-color rounded-md bg-bg-primary",
            {
             ...
             type="date" name="date" id="date"></input>
      </>
      )
      break;
    case "text":
    ...
    case "checkbox":
      inputZone = (
        ...
        <div className="flex flex-col">
          ...
          <input className="w-[40px] h-8 md:w-[40px] ml-7 md:ml-2 md:h-10 border-4 border-border-input-color rounded-md bg-bg-primary" type="checkbox" name="checkbox" id="checkbox"></input>
        </div>
        </>
      )
      break;
      ...
      inputZone = (
        <>
          ...
          ])}  type="textarea" name="textarea" id="textarea"></input>
        </>
      ) 
      break;
      case "file":
